...
/**
 * Concrete skill metadata carried by an {@link import("../agent").AgentDefinition}.
 *
 * Like {@link Skill} but `location` is optional — a portable agent definition
 * carries the skill content itself and need not point at a file on disk.
 */
