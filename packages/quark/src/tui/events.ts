...
import type { TypedBus, BusEventName, BusEvents } from "@quark/runner/session/events"
...
export function wireEvents(state: AppState, bus: TypedBus) {
  ...
  // sessionId is null (e.g. /new or worktree switch before first message).
