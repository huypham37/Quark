// Profile system — app-side compatibility source for agent identity.
//
...
//
// This is deliberately NOT part of @quark/runner: profiles are app
// compatibility that `agent-compat.ts` materializes into a portable
// AgentDefinition. The engine never reads profile YAML.
//
